...
export interface FundingTransaction {id:Id;accountId:Id;providerName:string;providerReference:string;canonicalAmount:Money;collectionAmount:Money;
  conversionSnapshot?:PaymentConversionSnapshot;state:FundingState;idempotencyKey:string;providerInitialization?:{authorizationUrl?:string;accessCode?:string};confirmedAt?:Date;initializationClaimedAt?:Date;}
export interface FundingRepository {
  ...
  claimInitialization(id:Id,staleBefore:Date,claimedAt:Date):Promise<FundingTransaction|null>;
