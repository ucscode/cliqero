...
Operator APIs require a directly authorized account and `operations:manage` for API-key callers. Accounts without `finance.read` cannot inspect these routes. Withdrawals, treasury consequences, and operational workers remain separate milestones.
