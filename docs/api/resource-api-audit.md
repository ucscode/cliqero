...
| GET, POST, PATCH, DELETE | `/api/integrations/{id}`                                          | integration credential               | session-only/owner     | KEEP; revoke remains resource deletion semantics for the credential                                     |
...
| GET, PATCH, DELETE       | `/api/listings/{id}`                                              | listing                              | public/owner           | KEEP; delete archives rather than physically deletes and should be reviewed with listing lifecycle docs |
...
| GET, PATCH, DELETE       | `/api/operator/listings/{id}/integrations/{integrationId}`        | operator integration                 | operator               | KEEP                                                                                                    |
...
| GET, PATCH, DELETE       | `/api/operator/listings/{id}`                                     | operator listing                     | operator               | KEEP; lifecycle mutation remains domain-owned                                                           |
